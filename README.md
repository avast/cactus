...
It can happen the case class has more fields than the GPB and you wan't just ignore them during the conversion. You can use `Ignored`
annotation to achieve this. Please note, that the ignored field in case class has to have default value!
