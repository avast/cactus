...
trait V3Converters {
  implicit val listValue2SeqConverter: Converter[com.google.protobuf.ListValue, Seq[ValueOneOf]] = Converter.fromOrChecked { (fieldPath, listValue) =>
  ...
  implicit val struct2MapConverter: Converter[com.google.protobuf.Struct, Map[String, ValueOneOf]] = Converter.fromOrChecked { (fieldPath, struct) =>
